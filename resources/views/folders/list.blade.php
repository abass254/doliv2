                        ...
                        <tbody id="orders">
							...
							<tr class="btn-reveal-trigger">
								...
								<td class="py-2" style="width:12px;">
									<a href="#">
										<strong class="text-primary"></strong></a> <strong class="text-primary">{{ $dt['folder_name'] ?? 'N/A' }}
										</strong><br><a href="{{ $dt['email'] }}">{{ $dt['email'] ?? 'N/A' }}</a>
                                </td>
								<td class="py-2 text-end">
									<a href="/uploaded_file/{{$dt['id']}}" class="btn btn-info btn-sm"><b>VIEW</b></a>
								</td>
							</tr>
							@endforeach
						</tbody>
